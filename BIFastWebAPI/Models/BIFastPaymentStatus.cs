...
namespace BIFastWebAPI.Models
{
    ...
    public class RespPaymentStatus
    {
        ...
        public string DebitorSettlementAccount { get; set; }
        public string CreditorSettlementAccount { get; set; }
    }

    public class RespRejectPaymentStatus
    {
        public string MsgDefIdr { get; set; }
        public string TranRefNUM { get; set; }
        public string MsgCreationDate { get; set; }
    ...
    public class RespErrPaymentStatus
    {
    ...
    public class RespAllPaymentStatus
    {
