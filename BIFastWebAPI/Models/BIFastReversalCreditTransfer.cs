...
{
    public class ReqReversalCreditTransfer
    {
        ...
        public string RltdEndToEndId { get; set; }
    }

    public class RespReversalCreditTransfer
    {
        public string MsgDefIdr { get; set; }
        public string TranRefNUM { get; set; }
        public string MsgCreationDate { get; set; }
    ...
    public class ViewModelReversal
    {
